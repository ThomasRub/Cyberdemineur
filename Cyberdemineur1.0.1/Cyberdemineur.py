...
def changer_musique():
    ...
    global son_joue
    if son_joue==6:
        PlaySound("Ressource/mainloop1.wav",SND_ASYNC|SND_LOOP)
        son_joue=1
        print("son = mainloop1")
    elif son_joue==1:
        PlaySound("Ressource/mainloop2.wav",SND_ASYNC|SND_LOOP)
        son_joue=2
        print("son = mainloop2")
    elif son_joue==2:
        PlaySound("Ressource/mainloop3.wav",SND_ASYNC|SND_LOOP)
        son_joue=3
        print("son = mainloop3")
    elif son_joue==3:
        PlaySound("Ressource/mainloop4.wav",SND_ASYNC|SND_LOOP)
        son_joue=4
        print("son = mainloop4")
    elif son_joue==4:
        PlaySound("Ressource/mainloop5.wav",SND_ASYNC|SND_LOOP)
        son_joue=5
        print("son = mainloop5")
    elif son_joue==5:
        PlaySound("Ressource/mainloop6.wav",SND_ASYNC|SND_LOOP)
        son_joue=6
        print("son = mainloop6")
...
def mute():
    global etat_mute
    if etat_mute==False:
        PlaySound("Ressource/sound_mute.wav",SND_ASYNC|SND_LOOP)
        etat_mute=True
    else:
        changer_musique()
        etat_mute=False
...
##Menu Principal
img_menu_fond_pilar=Image.open('Ressource/menu_fond.png')
...
img_menu_bouton_jouer_pilar=Image.open('Ressource/menu_bouton_jouer.png')
...
img_menu_bouton_quitter_pilar=Image.open('Ressource/menu_bouton_quitter.png')
...
img_menu_bouton_classement_pilar=Image.open('Ressource/menu_bouton_classement.png')
...
img_menu_bouton_options_pilar=Image.open('Ressource/menu_bouton_options.png')
...
##Menu des options
img_options_fond_pilar=Image.open("Ressource/options_fond.png")
...
img_options_bouton_aide_pilar=Image.open('Ressource/options_bouton_aide.png')
...
img_options_bouton_fond_pilar=Image.open('Ressource/options_bouton_fond.png')
...
img_options_bouton_menu_pilar=Image.open('Ressource/options_bouton_menu.png')
...
img_options_bouton_musique_pilar=Image.open('Ressource/options_bouton_musique.png')
...
classement_fond_pilar=Image.open("Ressource/classement_fond.png")
...
difficultes_fond_pilar=Image.open("Ressource/difficultes_fond.png")
...
difficultes_bouton_facile_pilar=Image.open('Ressource/difficultes_bouton_facile.png')
...
difficultes_bouton_moyen_pilar=Image.open('Ressource/difficultes_bouton_moyen.png')
...
difficultes_bouton_difficile_pilar=Image.open('Ressource/difficultes_bouton_difficile.png')
...
difficultes_bouton_menu_pilar=Image.open('Ressource/difficultes_bouton_menu.png')
...
##Écran de défaite
ecran_defaite_pilar=Image.open("Ressource/dommage_fond.png")
...
dommage_bouton_menu_pilar=Image.open('Ressource/dommage_bouton_menu.png')
...
dommage_bouton_quitter_pilar=Image.open('Ressource/dommage_bouton_quitter.png')
...
##Écran de victoire
ecran_victoire_pilar=Image.open("Ressource/bravo_fond.png")
...
bravo_bouton_menu_pilar=Image.open('Ressource/bravo_bouton_menu.png')
...
bravo_bouton_sauvegarder_score_pilar=Image.open('Ressource/bravo_bouton_sauvegarder_score.png')
...
case_bombe_pilar=Image.open("Ressource/case_bombe.png")
...
preview_fond_pilar=Image.open('Ressource/fond1.png')
...
preview_fond_pilar=Image.open('Ressource/fond2.png')
preview_fond_pil=preview_fond_pilar.resize((taille_preview1,taille_preview2))
preview_fond2=ImageTk.PhotoImage(preview_fond_pil)

preview_fond_pilar=Image.open('Ressource/fond3.png')
preview_fond_pil=preview_fond_pilar.resize((taille_preview1,taille_preview2))
preview_fond3=ImageTk.PhotoImage(preview_fond_pil)

preview_fond_pilar=Image.open('Ressource/fond4.png')
preview_fond_pil=preview_fond_pilar.resize((taille_preview1,taille_preview2))
